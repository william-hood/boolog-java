import io.github.william_hood.boolog_java.*;
...
public class BoologJavaExample {
    public static void main(String[] args) throws FileNotFoundException {
        ...
        Boolog log = new Boolog("Boolog Example (from Java)", new PrintWriter(System.out), new PrintWriter(outputFile), Boolog.THEME_DEFAULT);
